        ...
        <>
            <div className="min-h-screen pb-20">
                ...
                <div className={`fixed inset-0 z-100 bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    <a to="#" className="text-white">Home</a>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Writes Your Professional Story <span className=" bg-gradient-to-r from-green-700 to-green-600 bg-clip-text text-transparent text-nowrap">AI-Powered </span> Resume Builder.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Powered by advanced AI, this resume builder transforms your career data into a sleek, impactful resume. Get real-time content suggestions, formatting assistance, and keyword optimization — all with one click.</p>
